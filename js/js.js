...
$(document).ready(function() {
  ...
  input.on('keypress', function(evt) {
    ...
    var more_than_two_decimal =
      evt.key === decimal_separator && val.split(decimal_separator).length > 1;
    var has_invalid_symbols = evt.key.replace(regex_invalid_symbols, '') === '';

    if (more_than_two_decimal || has_invalid_symbols) {
      return false;
    }
  });
...
var currencyfield = {
  ...
  format_number: function(number, fixed) {
    ...
    var cents;
    var default_rounding_degree = Math.pow(
      10,
      fixed
        ? currencyfield.amount_rounding_degree
        : currencyfield.default_rounding_degree
    );
  ...
  check_valid: function(val) {
    ...
    if (match_three && match_three[0]) {
      ...
      var normalize_string = currencyfield
        .replaceAt(val, last_pos, '.')
        .replace(/,/g, '');
...
var test = {
  tested_data: function() {
    return [
      ...
      {
        input: '1000',
        valid: '1' + thousand_separator + '000' + decimal_separator + '00'
      },
      ...
      {
        input: '123.000',
        valid: '123' + decimal_separator + '00',
        variants: '123' + thousand_separator + '000' + decimal_separator + '00'
      },
      {
        input: '1,123',
        valid: '1' + decimal_separator + '123',
        variants: '1' + thousand_separator + '123' + decimal_separator + '00'
      },
      {
        input: '1,12345',
        valid: '1' + decimal_separator + '12345',
        variants: '112' + thousand_separator + '345' + decimal_separator + '00'
      },
      {
        input: '1,123,',
        valid: '1' + thousand_separator + '123' + decimal_separator + '00'
      },
      {
        input: '1,123.',
        valid: '1' + thousand_separator + '123' + decimal_separator + '00'
      ...
      {
        input: '1234',
        valid: '1' + thousand_separator + '234' + decimal_separator + '00'
      },
      {
        input: '1234,',
        valid: '1' + thousand_separator + '234' + decimal_separator + '00'
      ...
      {
        input: '1234.1',
        valid: '1' + thousand_separator + '234' + decimal_separator + '1'
      },
      {
        input: '1234,01',
        valid: '1' + thousand_separator + '234' + decimal_separator + '01'
      },
      {
        input: '1234,123',
        valid: '1' + thousand_separator + '234' + decimal_separator + '123',
        variants:
          '1' +
          thousand_separator +
          '234' +
      ...
      {
        input: '1.,523',
        valid: '1' + decimal_separator + '523',
        variants: '1' + thousand_separator + '523' + decimal_separator + '00'
      }
    ];
  },
  ...
  test: function() {
    $.each(test.tested_data(), function(b, tested_item) {
      ...
      if (tested_item.variants && tested_item.variants.length > 0) {
        if (
          tested_item.valid !== actual.variants[0] ||
          tested_item.variants !== actual.variants[1]
        ) {
