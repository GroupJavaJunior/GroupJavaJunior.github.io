...
function Car(props) {
  return e('div', { className: 'card' }, [
    e('div', { className: 'cart-img', key: 'div' }, e('img', { src: props.car.img, alt: props.car.name })),
...
const cars = [
  ...
  { name: 'Rolls Royce', price: 50000, img: 'https://www.rolls-roycecars.ru/upload/iblock/526/526e9e3b522d6e992afb6e5f7ac14628' },
